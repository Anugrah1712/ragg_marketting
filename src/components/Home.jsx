...
const Home = () => {
  ...
  return (
    <>
      <main>
        {/* ───────── HERO ───────── */}
        <section className="relative min-h-screen flex items-center justify-center bg-black overflow-visible">
          <GalaxyBackground />
  ...
  className={`absolute top-full left-1/2 transform -translate-x-1/2
    w-full max-w-[95vw] sm:max-w-[480px]
    px-3 sm:px-4 py-4
    border border-[#3c3c3c] bg-[#111111] shadow-xl
    z-[9999] rounded-xl transition-all duration-300
...
>
                  ...
                  {[
                    ...
                    <div key={label}>
                      ...
                      {idx < arr.length - 1 && (
                        <div className="border-t border-[#5f5f5f]/40 mx-4 my-2" />
                      )}
                    </div>
                  ))}
                </div>
        ...
        {/* ───────── MAIN TEXT SECTION ───────── */}
        <section className="relative min-h-[75vh] flex flex-col items-center justify-center bg-black/90 text-center px-4 overflow-hidden">
          <GalaxyBackground />
