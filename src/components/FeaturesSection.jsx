    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-14">
        ...
        <motion.div variants={cardVariants}>
          <div className="relative">
            <span className="absolute inset-0 rounded-2xl border border-blue-500 opacity-10 pointer-events-none animate-pulse"></span>
            <div className="bg-[#0b0e14] rounded-2xl border border-[#1f2937] p-6 shadow-xl relative z-10">
              ...
              <div className="flex items-center bg-[#111] rounded-lg px-3 py-2 border border-gray-700">
                ...
                <input
                  className="bg-transparent text-white ml-3 flex-1 outline-none"
                  placeholder="Message AI Assistant…"
                />
                <button className="text-blue-400 px-1">
                  <svg height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-400 mt-2">
                  We develop intelligent chatbots that leverage advanced NLP to elevate customer interactions and
        ...
        {/* ✅ Image Generator with glowing button and animated stars */}
        <motion.div variants={cardVariants}>
          <div className="relative">
            <span className="absolute inset-0 rounded-2xl border border-blue-500 opacity-10 pointer-events-none animate-pulse"></span>
            <div className="bg-[#0b0e14] rounded-2xl border border-[#1f2937] p-6 shadow-xl relative z-10">
              <div className="bg-[#0f1115] rounded-xl p-6 mb-4 relative overflow-hidden h-32 border border-[#1f2937]">
                ...
                <div className="absolute top-1/2 left-1/2 z-10 -translate-x-1/2 -translate-y-1/2">
                  <div className="px-4 py-1 rounded-full border border-blue-400 bg-[#0b0e14]/80 text-white text-sm font-medium shadow-[0_0_10px_#60a5fa40] flex items-center gap-1">
                    Generating image<span className="animate-ping w-2 h-2 bg-blue-400 rounded-full"></span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center bg-[#111] rounded-lg px-3 py-2 border border-gray-700">
                ...
                />
                <button className="text-blue-400 px-3 border border-blue-400 rounded-md text-sm py-1 hover:bg-blue-500/10 transition">
                  Generate
                </button>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-400 mt-2">
                  Our content creation solutions effortlessly generate high-quality, engaging content according to your
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        >
          ...
          <p className="text-gray-400 mt-2">We automate your workflows to streamline repetitive tasks, enhance efficiency, save time, and eliminate errors.</p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center bg-[#111] rounded-lg px-3 py-2 border border-gray-700 mb-4">
            <input className="bg-transparent text-white flex-1 outline-none" placeholder="And are Quokka's big?" />
            <button className="text-blue-400">
              <svg height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M22 2L11 13"></path><path d="M22 2L15 22L11 13L2 9L22 2Z"></path></svg>
            </button>
          </div>
          <h3 className="text-2xl font-semibold text-white drop-shadow-[0_0_0.3em_#60a5fa]">LLM Development</h3>
          <p className="text-gray-400 mt-2">We develop Large Language Models that transform how your company interacts with data and customers.</p>
        </motion.div>
...
>
  ...
  <div className="h-32 bg-gradient-to-r from-blue-500/10 to-blue-400/10 rounded-xl mb-4 relative overflow-hidden">
    ...
    <svg viewBox="0 0 200 100" className="absolute inset-0 w-full h-full">
      ...
      />
      {/* Pulsing dots */}
      {[[0, 80], [50, 70], [90, 50], [130, 40], [170, 30], [200, 25]].map(([cx, cy], idx) => (
        <motion.circle
          key={idx}
          cx={cx}
          cy={cy}
